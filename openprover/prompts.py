...
def worker_system_prompt(*, lean_worker_actions: bool = False) -> str:
    ...
    if lean_worker_actions:
        base += (
            ...
            "\n"
            "When formalizing a proof in Lean, work incrementally and modularly:\n"
            ...
            "4. Once a lemma or definition compiles without sorry, use `lean_store` to save it. "
            ...
            "\n"
            "**Never verify the same thing twice.** Work modularly — prove lemmas separately. "
            "Once a lemma compiles, store it with `lean_store` and move on. "
            "Only combine everything for a final full verification.\n"
            "\n"
