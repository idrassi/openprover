...
def _build_principles(*, lean_mode: str, has_lean: bool,
    ...
    principles = (
        ...
        "For case analysis or multiple approaches, assign one case per worker. "
        ...
        "- **Keep the whiteboard up-to-date.** Always write_whiteboard after receiving worker results. "
        "The whiteboard is your primary memory — if it's stale, you'll repeat work. "
        ...
        "define terms or use [[ref]] links. Long content belongs in repo items.\n"
